<template>
  <div class="frontend">
    <div class="frontend-hot">
        <div class="frontend-hot-head">
            <div class="left"><i class="iconfont">&#xe67c;</i>前端热门</div>
            <div class="right"><i class="iconfont refresh">&#xe6d3;</i><i class="iconfont">&#xe6bf;</i></div>
        </div>
        <div v-for="item in home.recommend">
            <div class="frontend-hot-list" @click="selectlist(item)">
...
<style>
  ...
  .frontend-hot-head .left {
    float: left;
    color: #007AFF;
    font-size: 15px;
    padding-left: 10px;
  }
  .frontend-hot-head .left i{
    padding-right: 5px;
    font-size: 15px;
  }
  .frontend-hot-head .right {
    float: right;
    padding-right: 10px;
  }
  .frontend-hot-head .right i {
  ...
  .frontend-hot-list .recommend-infor {
    float: left;
    width: 70%;
    padding-top: 20px;
    padding-left: 12px;
  ...
  .frontend-hot-list .recommend-img {
    position: absolute;
    width: 60px;
    height: 60px;
    right: 12px;
  ...
  .frontend-hot-list .recommend-img img {
    width: 60px;
    height: 60px;
  }
</style>
